...
| 타입 | 파일                                              | 설명                |
|----|-------------------------------------------------|-------------------|
| -  | [train_dataset_with_label_find_mean]()          | 활동, 수면 원천 데이터의 평균 |
| -  | [train_dataset_with_label_find_mean_with_nan]() | 활동, 수면 원천 데이터의 평균 |

**validation**

| 타입 | 파일                                            | 설명                |
|----|-----------------------------------------------|-------------------|
| -  | [val_dataset_with_label_find_mean]()          | 활동, 수면 원천 데이터의 평균 |
| -  | [val_dataset_with_label_find_mean_with_nan]() | 활동, 수면 원천 데이터의 평균 |